...
class MessagesDetailsModel {
  ...
  MessagesDetailsModel({this.responseCode, this.message, required this.data});

  MessagesDetailsModel.fromJson(Map<String, dynamic> json) {
    responseCode = json['response_code'];
    message = json['message'];
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['sent_on'] = this.sentOn;
    data['sent_by'] = this.sentBy;
    data['sent_by_name'] = this.sentByName;
    if (this.attachments != null) {
      data['attachments'] = this.attachments!.map((v) => v.toJson()).toList();
    }
    return data;
