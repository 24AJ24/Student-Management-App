...
/*
import 'package:flutter/material.dart';
import 'package:untitled11/primary_button.dart';
import 'package:untitled11/reset_form.dart';
import 'package:untitled11/theme.dart';
import 'login.dart';
...
import 'dart:convert'; // Assuming you have the model defined

class ForgotPasswordScreen extends StatelessWidget {
  final TextEditingController _usernameController = TextEditingController();

  Future<void> _sendPasswordResetRequest(String username) async {
    // Your existing code for sending password reset request
  }
